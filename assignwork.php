...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="addteam.php">Add a Team</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link text-white" href="assignwork.php">Assign work</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white" href="data.php">Data Center</a>
      </li>
      <li class="nav-item">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
              ...
              <div class="form-group">
              <p style="color: red;"> * To update dataset length or to extend dead line go to admin dashboard</p>
              </div>
        </form>
      </div>
    </div>
